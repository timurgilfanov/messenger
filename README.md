...
Showcase project demonstrating approach to build a large-scale Android application with maintainable codebase and scalable architecture using Kotlin and Jetpack Compose.
