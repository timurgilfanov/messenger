...
@Singleton
class SampleDataProviderImpl @Inject constructor() : SampleDataProvider {
     ...
     */
    override fun generateChats(config: DataGenerationConfig): List<Chat> = when (config.scenario) {
     ...
     */
    override fun generateSingleMessage(chat: Chat): Message {
