...
import timur.gilfanov.messenger.domain.usecase.chat.LeaveChatError.LocalError
import timur.gilfanov.messenger.domain.usecase.chat.LeaveChatError.NetworkNotAvailable
import timur.gilfanov.messenger.domain.usecase.chat.LeaveChatError.NotParticipant
import timur.gilfanov.messenger.domain.usecase.chat.LeaveChatError.RemoteError
import timur.gilfanov.messenger.domain.usecase.chat.LeaveChatError.RemoteUnreachable
