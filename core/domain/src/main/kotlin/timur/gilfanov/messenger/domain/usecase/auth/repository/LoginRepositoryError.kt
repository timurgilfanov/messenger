 ...
 *
 * ## Logical Errors
 * - [InvalidEmail] - The email was rejected by the server; see [LoginEmailError] for detail
...
sealed interface LoginRepositoryError {
    data class InvalidEmail(val reason: LoginEmailError) : LoginRepositoryError
